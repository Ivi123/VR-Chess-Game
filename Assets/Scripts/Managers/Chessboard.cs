...
public class Chessboard : MonoBehaviour
{
    ...
    {
        List<Vector3> blackEliminationPosition = new();
        List<Vector3> whiteEliminationPosition = new();
        ...
        {
            blackEliminationPosition.Add(whiteEliminationTiles.GetChild(i).position);
        }

        for (int i = 0; i < blackEliminationTiles.childCount; i++)
        {
            whiteEliminationPosition.Add(blackEliminationTiles.GetChild(i).position);
        }

        MovementManager.WhiteEliminationPosition = whiteEliminationPosition;
        MovementManager.BlackEliminationPosition = blackEliminationPosition;
    ...
    private void PositionSinglePiece(int x, int y)
    {
        ...
        MovementManager.ChessPieces[x, y].Chessboard = this;
